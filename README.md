...
> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/Munchhi/ioios)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `fcace6f5-3c59-4e00-b459-b92d2dc71771` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
| `AID` | `159` | 为进一步防止被探测所设额外 ID，即 AlterID，范围为 0 至 65535 |
